...
const JobList = () => {
  ...
  const experienceItems = {
    Mentorsity: {
      ...
      desc: [
        "Optimized server-side performance by implementing caching mechanisms, reducing server load by 30%.",
        "Contributed to code reviews, enhancing code quality and maintainability for future development.",
        "Designed and deployed an internal tool to boost operational productivity, now used by 100+ employees."
      ]
    },
    "VOAT Network": {
      jobTitle: "Backend Intern",
      ...
      desc: [
        "Contributed to the architecture of a major company project, designing a scalable backend system capable of handling 1k+ concurrent users.",
        "Developed and optimized core functionalities for the company’s website using Node.js and Express.js, improving page load speed by 10% and reducing server response time by 15%.",
        "Enhanced backend workflows and API integration, leading to faster client query resolution and significantly improved client engagement rates."
      ]
    }
    // Amazon: {
